...
describe('Ingestion', () => {
  ...
  describe('Live Activity Tab', () => {
    ...
    const mockStats: IngestionStatsResponse = {
      ...
      incremental_speedup: 2.5,
      avg_processing_time_ms: 1500,
      peak_processing_time_ms: 5000,
      ...
      success_rate: 86.7,
      failure_rate: 10.0,
      time_since_last_failure_minutes: 15,
      timeseries_24h: [],
      avg_parse_duration_ms: 500,
      avg_deduplication_check_ms: 100,
      avg_database_operations_ms: 300,
      avg_tagging_duration_ms: 600,
      avg_llm_tagging_ms: 550,
      avg_llm_prompt_tokens: 1000,
      avg_llm_completion_tokens: 500,
      avg_llm_total_tokens: 1500,
      avg_llm_cost_usd: 0.002,
      total_llm_cost_usd: 0.30,
    };
  ...
  describe('History & Logs Tab', () => {
    const mockStats: IngestionStatsResponse = {
      ...
      jobs_last_hour: 20,
      jobs_last_24h: 95,
      processing_rate_per_minute: 2.0,
      success_rate: 90.0,
      failure_rate: 8.0,
      time_since_last_failure_minutes: 30,
      timeseries_24h: [],
      avg_parse_duration_ms: 400,
      avg_deduplication_check_ms: 80,
      avg_database_operations_ms: 250,
      avg_tagging_duration_ms: 470,
      avg_llm_tagging_ms: 420,
      avg_llm_prompt_tokens: 900,
      avg_llm_completion_tokens: 450,
      avg_llm_total_tokens: 1350,
      avg_llm_cost_usd: 0.0018,
      total_llm_cost_usd: 0.18,
    };
